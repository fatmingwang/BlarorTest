...
//namespace Common
//{
var cCommonFunction = /** @class */ (function () {
    function cCommonFunction() {
    }
    ////https://stackoverflow.com/questions/75072133/blazor-wasm-create-and-download-a-file
    cCommonFunction.prototype.DownloadFile = function (e_strURI) {
    ...
    return cCommonFunction;
}());
//}
function getCommonInstance() {
